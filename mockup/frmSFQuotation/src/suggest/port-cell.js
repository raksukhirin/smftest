/* suggest/port-cell.js — Cell-level Port smart-suggest for FCL port cells. */
window.SFQ = window.SFQ || {};
window.SFQ.suggestPortCell = (function () {
    'use strict';
    ...
    function installPortCellSuggest() {
