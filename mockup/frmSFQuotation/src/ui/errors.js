/* ui/errors.js — Error UI: clear, mark, modal.
 * Validation logic itself lives in validation.js. */
window.SFQ = window.SFQ || {};
window.SFQ.errors = (function () {
    'use strict';
    ...
    return { clearErrors, applyErrors, showErrorModal, hideErrorModal };
}());
