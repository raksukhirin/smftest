/* grids/fcl.js — FCL (Freight & Charges) grid, bound to SFQRATE.
 * 21 visible columns + index + delete. All rate columns are text inputs
 * because SFQRATE is VARCHAR — accepts "FREE", "20-24", numbers, etc. */
